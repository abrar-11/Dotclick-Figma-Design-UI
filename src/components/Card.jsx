...
const Card = ({ data }) => {
  ...
  return (
    <div className="w-1/3 max-w-sm border-2 border-gray-200 rounded-lg relative bg-[#F5F4F4] shadow-md">
      <div className="py-3">
      ...
      >
        <p className="text-center text-sm text-[#959595] mb-2 font-medium font-lato">
          {desc}
        </p>
